                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    String ChinhThuc;
                                                %>
                                                <%for (Theloaisach item : theLoaiSachDAO.getList()) {%>
                                                <tr>
                                                    <td><%=i++%></td>
                                                    <td><%=item.getTen()%></td>
                                                    <td class="Action">
                                                        ...
                                                        <button class="btn_edit" val1="<%=item.getId()%>" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#Edit"><i class="glyphicon glyphicon-plus" ></i>
                                                            <a class="btn_delete" href="/TVDT_FI1/TheloaisachActionController?Action=Edit&id=<%=item.getId()%>">Edit</a></button>
                                                        <button  val1="<%=item.getId()%>" onclick=" return confirm('Bán muốn xóa?')" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#Delete"><i class="glyphicon glyphicon-home"></i>
                                                            <a class="btn_delete" href="/TVDT_FI1/TheloaisachActionController?Action=Delete&id=<%=item.getId()%>">Delete</a>
                                                        </button>
                                                    </td>
                                                </tr>
                                                <%}%>
                                        ...
                                        <button type="button" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#Add">
                                            <a class="btn_delete" href="/TVDT_FI1/TheloaisachActionController?Action=Add">Add</a></button>
                                    </div>
                                </div>
                            </div>
                            <!-- End  Kitchen Sink -->
