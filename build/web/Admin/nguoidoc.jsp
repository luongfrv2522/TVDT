                    ...
                    <ul class="nav" id="main-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="nguoidoc.jsp" class="active-menu"><i class="fa fa-toggle-on"></i>Người đọc truyện</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    String ChinhThuc;
                                                %>
                                                <%for (Nguoidoc item : nguoiDocDAO.getList()) {%>
                                                <%
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="Action">
                                                        ...
                                                        <button class="btn_edit" val1="<%=item.getId()%>" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#Edit"><i class="glyphicon glyphicon-plus" ></i>
                                                            <a class="btn_delete" href="/TVDT_FI1/NguoiDocActionController?Action=Edit&id=<%=item.getId()%>">Edit</a></button>
                                                        <button  val1="<%=item.getId()%>" onclick=" return confirm('Bán muốn xóa?')" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#Delete"><i class="glyphicon glyphicon-home"></i>
                                                            <a class="btn_delete" href="/TVDT_FI1/NguoiDocActionController?Action=Delete&id=<%=item.getId()%>">Delete</a>
                                                        </button>
                                                    </td>
                                                </tr>
                                                <%}%>
                                        ...
                                        <button type="button" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#Add">
                                            <a class="btn_delete" href="/TVDT_FI1/NguoiDocActionController?Action=Add">Add</a></button>
                                    </div>
                                </div>
                            </div>
                            <!-- End  Kitchen Sink -->
