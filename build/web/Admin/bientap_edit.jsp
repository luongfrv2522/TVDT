        ...
        <div id="wrapper">
                    ...
                    <ul class="nav" id="main-menu">
                        ...
                        <a href="#"><i class="fa fa-desktop "></i>Quản lý nhân lực <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu" href="bientap.jsp"><i class="fa fa-toggle-on"></i>Biên tập</i></a>
                            </li>
                            <li>
            ...
            <div id="page-wrapper">
                <div id="page-inner">
                    ...
                    <div class="col-md-10">
                        <%
                             Bientap bientap = (Bientap) request.getAttribute("item");
                            String Action="Add";
                            if(bientap!=null){
                                Action="Edit";
                            }
                            String URLAtion = "/TVDT_FI1/BienTapActionController?Excute=1&Action="+Action;
                        %>
                    <form role="form" method="POST" action="<%=URLAtion%>">
                        ...
                        <div class="form-group">
                            <label>Giới tính</label>
                            <select name="chinh_thuc" class="form-control" value="<%=Common.noteNULL(String.valueOf(bientap.isGioiTinh()))%>">
