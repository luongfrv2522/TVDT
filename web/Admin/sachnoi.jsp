                    ...
                    <ul class="nav" id="main-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active-menu" href="/TVDT_FI1/Admin/sachnoi.jsp"><i class="fa fa-toggle-on"></i>Sách nói</a>
                                </li>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    String ChinhThuc;
                                                %>
                                                <%for (Sachtruyenthong item : sachTruyenThongDAO.getList()) {%>
                                                <%
                                                    trangThai = item.getTrangThai()==1? "Còn" : "Đã mượn";
